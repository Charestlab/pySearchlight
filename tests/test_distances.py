...
from searchlight.searchlight import get_distance, upper_tri_indexing
...
class TestDistances(unittest.TestCase): 
    ...
    def test_get_distance(self):
        ...
        d = get_distance(data, centers[0])
        d2 = get_distance_cdist(data, centers[0])

        assert_array_almost_equal(d, d2)

    def test_get_corr(self):
